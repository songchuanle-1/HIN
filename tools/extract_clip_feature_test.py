...
def extract_feature(clip_variant, device):
    image_dir = '/speedup_data/slurm_data/songcl_data_place/DFT_data/features/coco2014/%s2014'
    base_path = '/speedup_data/slurm_data/songcl_data_place/DFT/annotations/image_info_%s2014.json'

    save_path = os.path.join('/speedup_data/slurm_data/songcl_data_place/DFT_data/features/coco2014/', 'COCO2014_%s_A100_produce_test.hdf5' % clip_variant)
