...
def test():
    ...
    weight_files = ['coco/checkpoints/paper_weights/decoder_cca_multi_feature_gate1_encoder_gce_query2att_exchange_add_mask_output_threetoken_middle_feature2_noshortcut_for_decoder_best_test.pth',
    ...
    output_path = 'outputs/result/captions_test2014_SD_results.json'
